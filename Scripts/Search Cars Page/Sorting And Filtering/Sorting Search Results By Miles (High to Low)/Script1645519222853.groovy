...
WebUI.click(findTestObject('Search Cars Page/Sorting Options/select_Miles (High to Low)'))

WebUI.waitForPageLoad(2)

CustomKeywords.'driveTime.SearchCarsPage.verifySortingByMilesHighToLow'()
